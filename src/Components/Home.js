...
function Home() {
  return (
    <div className='container' style={{justifyContent:"center",textAlign:"center", backgroundColor:'cream', width:'90vw',margin:"auto", display:"flex"}}>
        <div style={{backgroundImage:`url(${home_image})`, minHeight:"1700px", width:"50vw", backgroundSize:"cover",backgroundColor:"green", backgroundRepeat:"no-repeat", padding:"10px",justifyContent:"center",textAlign:"center",display:"flex"}}>
